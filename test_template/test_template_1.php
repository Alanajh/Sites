...
<body style="padding: 10px;"> 
	...
	<!-- MENU, LOGO & TITLE -->
		<div class="row">
			<div class="col-sm-3 col-md-3 col-lg-3"><img src="C:\Users\dh499d\Desktop\Projects\Nutmeg\img\nutmeg-800x800.png" style="width: 100px; height:100px;"/>
			</div>
			...
			<div class="col-sm-3 col-md-3 col-lg-3">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#">username | log off &#9;<img src="C:\Users\dh499d\Desktop\Projects\Nutmeg\img\avatar-placeholder.png" style="width: 30px; height: 30px;"/></a></li>
				</ul>
			</div>
		</div>
	</div>
